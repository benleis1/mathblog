...
I'm running the club as a hybrid math circle / math competition club. That means in practice, I've been buying and reading a set of math circle diaries and books and scouring the web for interesting ideas. Sometimes we practice a bit in preparation for the next contest and others we engage in a mathematical exercise or game for the day. My main focus is to try out a lot of different activities in the hopes of interesting the kids and deepening their understanding. This is not always easy and I'm still evaluating week to week what seems to work and what draws out the most from the kids.

##  Geometry Formatting
From the start I liked experimenting and creating diagrams in geogebra. (The classic version remains the best) Somewhere in the middle of blogging several years ago I also encountered Oliver Byrne's 
["The First Six Books of the Elements of Euclid, in which Coloured Diagrams and Symbols are used instead of Letters for the Greater Ease of Learners."](https://www.milestone-books.de/pages/books/003806/oliver-byrne-euclid/the-first-six-books-of-the-elements-of-euclid-in-which-coloured-diagrams-and-symbols-are-used).  I take a lot of inspiration from his visual style.

---
You can find me on [Mastodon](https://mathstodon.xyz/@benleis)
