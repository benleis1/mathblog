...
Then last Friday, our official MathCounts team packet arrived with the lovely poster from my [last post](http://mymathclub.blogspot.com/2017/10/this-years-math-count-poster.html).    My own son found the poster intriguing and I was fairly sure everyone else would too. So I started with a group whiteboard attempt at the problem.
