...
author: me
image:
  path: "{{ site.baseurl }}/assets/img/blogger_8df3e4ba.png"
---

![]({{ site.baseurl }}/assets/img/blogger_8df3e4ba.png){:width="120%"}
*Graphic scores by John De Cesare (1890–1972).*

Welcome to the 203rd Carnival. For all the other carnivals future and past,
visit
[The Aperiodical ](https://www.blogger.com/blog/post/edit/4227811469912372962/6398802341507033330#)where you can also submit future posts.  This is my fifth go around
...
[Pi Day Digit Song](https://www.youtube.com/watch?v=3HRkKznJoZA) quite amusing this year)

 

 
 Before we really get going via
 [wikipedia.org](http://wikipedia.org) here are few facts
 about the number 203.  (We're getting higher up the ordinals and sadly
 the list of references is getting shorter)
 
 
203 is the seventh
 [Bell number](https://en.wikipedia.org/wiki/Bell_number), giving
 the number of
 ...
 [polyomino](https://en.wikipedia.org/wiki/Polyomino) formed by
 stacks of unit squares of heights ranging from 1 to 12.

## 
 All things π

 
 ![]({{ site.baseurl }}/assets/img/blogger_ea2cc391.gif)
 ...
 **David Berardo - Pi Digit Distribution**
 ...
 I really enjoyed the set of *mostly *new pi videos I watched this
 ...
 [https://youtu.be/-LVpjnaqtwU](https://youtu.be/-LVpjnaqtwU)
 
 

 Speaking of folks attempting to calculate pi, Matt Parker continued his
 ...
 found  this writeup on  Mancin's formula [http://personalpages.to.infn.it/~zaninett/pdf/machin.pdf](http://personalpages.to.infn.it/~zaninett/pdf/machin.pdf) quite useful.

 

 On a more artistic theme, Vi Hart had a new video up as well where she worked
 ...
 Somewhere in the middle of all this serious and/or beautiful material  I
 also found the   Talking Numbers blog a welcome bit of light humor:

 
 ![]({{ site.baseurl }}/assets/img/blogger_bacc4b97.png)
 ...
 [http://docmadhattan.fieldofscience.com/2022/03/pi-day-viete-infinite-series.html](http://docmadhattan.fieldofscience.com/2022/03/pi-day-viete-infinite-series.html)   
 ...
 Penultimately, I'm including one slightly older video that I also watched
 ...
 derivation of the  [Arctangent Taylor Series](https://proofwiki.org/wiki/Power_Series_Expansion_for_Real_Arctangent_Function) and then trying out converting it by hand into a [continued fraction](https://functions.wolfram.com/ElementaryFunctions/ArcTan/10/).    Watch this one in a pair with Matt Parker's one.
...
> 
 ...
 I wrote a poem about circles for
 [#PiDay](https://twitter.com/hashtag/PiDay?src=hash&ref_src=twsrc%5Etfw)
 then I put on my fave circle t-shirt and filmed it walking around in a big
 circle. Enjoy x
 [pic.twitter.com/jzxwEOBZKv](https://t.co/jzxwEOBZKv)
 

 — Harry Baker (@harrybakerpoet)
 [March 14, 2022](https://twitter.com/harrybakerpoet/status/1503296176917041153?ref_src=twsrc%5Etfw)
 ...
 ![]({{ site.baseurl }}/assets/img/blogger_3094f043.png)
 
 
 **Prime Number of the Day -
 [Danesh Forouhari](https://twitter.com/dforouhari)**
...
## All the Rest Of Mathematics
 ...
 ![]({{ site.baseurl }}/assets/img/blogger_869f595b.jpg)
 
 

 

And now for something completely different ... First up is a lovely post
on Noether's Therorem by  Gianluigi Filippelli:  [http://docmadhattan.fieldofscience.com/2022/03/noethers-theorem.html](https://www.blogger.com/blog/post/edit/4227811469912372962/6256346026660681186#)  On my bucket list is to someday go back and really understand Lie
groups.

 
 ![]({{ site.baseurl }}/assets/img/blogger_15ed87f9.png)
 
 

Patrick Honner has a new article up on Quanta Magazine:

 [https://www.quantamagazine.org/what-a-math-party-game-tells-us-about-graph-theory-20220324/](https://www.quantamagazine.org/what-a-math-party-game-tells-us-about-graph-theory-20220324/)
 ...
 ![]({{ site.baseurl }}/assets/img/blogger_52590148.gif)

**Daniel Piker - Cubes**

 
 On a related topic Tivadar Danka offered this fascinating thread on Twitter
 on the intesection between graph theory and linear algebra which I had never
 seen before and found really cool.
...
> 
 ...
 The single most undervalued fact of linear algebra: matrices are graphs,
 and graphs are matrices.

Encoding matrices as graphs is a cheat
 code, making complex behavior simple to study.

Let me show you
 how! [pic.twitter.com/8rBIkA8ZbZ](https://t.co/8rBIkA8ZbZ)
 

 — Tivadar Danka 🇺🇦 (@TivadarDanka) [March 11, 2022](https://twitter.com/TivadarDanka/status/1502215264544296962?ref_src=twsrc%5Etfw)
 

Here's another more metaphysical podcast from Tattva Deep  from one of
their podcasts recently:

 " In this short video, we share some common and some not-so-common questions
...
Link: [https://www.youtube.com/watch?v=OYp-HXEFsdg](https://www.youtube.com/watch?v=OYp-HXEFsdg)

 
 

 
 ![]({{ site.baseurl }}/assets/img/blogger_b39e8462.gif)
 ...
 **Matt Henderson - Mandelbrot Set**
 ...
 Cameron Son writes this contemplative piece about his numeric visualization
 process:

"When doing any sort of mental arithmetic or
...
[http://www.csun.io/2022/03/03/how-i-see-numbers.html](https://www.blogger.com/#)
...
And in our final entry for the month we have another well done video
 this time on Artificial Intelligence and pure mathematics.
...
with the intuitive
 ...
 Thanks again for reading. As usual the process of preparing this write
 up led me down so many interesting mathematical rabbit holes.
 
 

 
 
 ![]({{ site.baseurl }}/assets/img/blogger_4134a633.png)
