...
This is a generalization of some of the ideas in: [previous post](https://mymathclub.blogspot.com/2016/10/12-triangles-and-their-link-to.html).    Its not just the angles in  1:2 and 1:3 triangles that add up to 45 degrees.  You can form an infinite number of  pairs: 6:16 and  5:11 or  1:7 and 3:4  or   34:96  and  31:65 etc.
