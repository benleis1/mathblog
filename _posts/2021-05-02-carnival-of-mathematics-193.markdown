---
title: "Carnival of Mathematics 193"
date: 2021-05-02 23:56:00 +0000
tags:
  - carnival of math
author: me
---
...
![]({{ site.baseurl }}/assets/img/carnival-of-mathematics-193/blogger_d329f3f2.jpg)
  ...
  **(Ancient Roman mosaic floor patterns - @HistoryJourney)**
  ...
  Welcome to the 193rd Carnival and my fourth! time hosting. For all the other carnivals future and past, visit [The Aperiodical ](https://aperiodical.com/carnival-of-mathematics/)where you can also submit future posts. It's been a wild ride since [Carnival 181]({% post_url 2020-05-02-carnival-of-mathematics-181 %}), spent mostly in the confines of my home office. Thankfully, I've been lucky enough to avoid the worst suffering of the pandemic. Life goes on so as the initial shock passed I've learned a great deal about doing remote math with students, epidemiology, the nature of resilience, and the comparative advantages of Zoom vs WebEx vs Google Meetings.
...
<p/>
  ...
  And while 193 doesn't resonate particularly strongly with me, in honor of this
  being my fourth go about, here's one my favorite geometric facts about
...
# Submissions
  ...
  has a divergent but compelling view of the direction of the field that's worth
  checking out.  This  piece is more of a tour of the highlights of
  Hawking's career from a physics perspective than dive into the math
  involved  But if like me you are more aware of Hawking as a celebrity versus
  his actual work it serves as a good overview.

  ![]({{ site.baseurl }}/assets/img/carnival-of-mathematics-193/blogger_ef796703.jpg)

**Geometry Interlude**

  Next, there were a few submissions from
...
[**https://youtu.be/ENfuCar4zvI**](https://youtu.be/ENfuCar4zvI)
  ...
  You should check out the entire video but I particularly liked this highlight
  at the end. Exercise for the reader. Try this out and puzzle out  *Why does this work?*

  ![]({{ site.baseurl }}/assets/img/carnival-of-mathematics-193/blogger_8cab5a36.PNG)

  ![]({{ site.baseurl }}/assets/img/carnival-of-mathematics-193/blogger_f4644f82.PNG)

For something a little more advanced but visually quite engrossing Anna Seigal
has a post up on "Three Correlations and an algebraic classification" [https://picturethismaths.wordpress.com/2021/03/18/three-correlations-and-an-algebraic-classification/](https://picturethismaths.wordpress.com/2021/03/18/three-correlations-and-an-algebraic-classification/)
...
[https://www.theguardian.com/books/2021/apr/10/catherine-menon-pure-mathematics-and-writing-come-out-of-the-same-creative-space](https://www.theguardian.com/books/2021/apr/10/catherine-menon-pure-mathematics-and-writing-come-out-of-the-same-creative-space)
        ...
        maths. Pure mathematics is very abstract: it’s a language of ideas
        rather than numbers. The value of a proof will often lie in how elegant
        or interesting it is, just like the value of writing. Obviously, proofs
...
Meanwhile over on R J Lipton's blog there is an overview of Lola Thompson's recent work:[https://rjlipton.wpcomstaging.com/2021/04/18/summing-up-the-primes/](https://rjlipton.wpcomstaging.com/2021/04/18/summing-up-the-primes/)

There's a lot to digest in this post but one of the most interesting parts is the discussion the Mobius and Merten's functions
![]({{ site.baseurl }}/assets/img/carnival-of-mathematics-193/blogger_2d15327c.jpg)
