...
Background
  ...
  I'm assuming that you're already familiar with polar coordinates and cis
  ...
  By directly evaluating the expressions we can start off by showing the complex
